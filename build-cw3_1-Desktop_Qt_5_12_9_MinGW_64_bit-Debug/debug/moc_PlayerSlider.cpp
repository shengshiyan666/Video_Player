...
#include "../../version6/PlayerSlider.h"
...
QT_MOC_LITERAL(3, 34, 11), // "sigProgress"
QT_MOC_LITERAL(4, 46, 10) // "onTimerOut"

    },
    "PlayerSlider\0costomSliderClicked\0\0"
    "sigProgress\0onTimerOut"
};
...
void PlayerSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sigProgress((*reinterpret_cast< qint64(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayerSlider::costomSliderClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PlayerSlider::costomSliderClicked()
{
